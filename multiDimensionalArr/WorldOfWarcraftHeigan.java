...
public class WorldOfWarcraftHeigan {
    public static void main(String[] args) {
        ...
        double playerDame = Double.parseDouble(scanner.nextLine());
        String lastSpell = "";
        while (true) {
            if (playerHP >= 0) {
                heiganHP -= playerDame;
        ...
        String playerCoordinates = String.format("Final position: %d, %d", playerRow, playerCol);
